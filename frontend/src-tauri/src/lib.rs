...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ollama::commands::get_ollama_models,
            ollama::commands::pull_ollama_model,
            ollama::commands::delete_ollama_model,
            ollama::commands::get_ollama_model_context,
            openai::commands::get_openai_models,
            anthropic::commands::get_anthropic_models,
            groq::commands::get_groq_models,
