...
export const MODEL_CONFIGS: Record<string, Partial<ModelInfo>> = {
  ...
  "large-v3": {
    description:
      "Highest accuracy, best for important meetings. Slower processing.",
    size_mb: 2951,
    accuracy: "High",
    speed: "Slow",
  },
  ...
  small: {
    description:
      "Fast processing with good quality. Great for quick transcription.",
    size_mb: 466,
    accuracy: "Good",
    speed: "Medium",
  },
  ...
  "medium-q5_0": {
    description:
      "Quantized medium model, professional quality with better speed.",
    size_mb: 514,
    accuracy: "High",
    speed: "Medium",
  },
...
export function groupModelsByBase(
  models: ModelInfo[],
