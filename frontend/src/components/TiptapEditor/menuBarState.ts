...
export function menuBarStateSelector(ctx: EditorStateSnapshot<Editor | null>) {
  if (!ctx.editor) {
    return {
      ...
      canAddColumnBefore: false, canAddColumnAfter: false, canDeleteColumn: false,
      canAddRowBefore: false, canAddRowAfter: false, canDeleteRow: false,
      canDeleteTable: false, canMergeCells: false, canSplitCell: false,
      canToggleHeaderRow: false, canToggleHeaderColumn: false, canToggleHeaderCell: false,
