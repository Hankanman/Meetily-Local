...
//! Reads/writes `recording_preferences` (`meetily-core/src/audio/recording_preferences.rs`),
...
fn set_recording(
    ...
    mutate: impl FnOnce(&mut meetily_core::audio::recording_preferences::RecordingPreferences),
) {
    let updated = {
