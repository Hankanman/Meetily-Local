...
use meetily_core::audio::devices;
use meetily_core::audio::recording_phase::{RecordingPhase, RecordingSnapshot};
...
/// (`meetily_core::audio::transcription::partial_worker`'s private
...
impl RecordingView {
    ...
    fn apply_device_list(
        &mut self,
        devices: Vec<meetily_core::audio::pw::PwDevice>,
        prefs: &RecordingPreferences,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
        use meetily_core::audio::pw::PwDeviceKind;
