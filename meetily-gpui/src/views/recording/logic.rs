...
use meetily_core::audio::simple_level_monitor::AudioLevelData;
...
/// `transcript-update` (`meetily_core::audio::transcription::worker::TranscriptUpdate`)
/// or the in-progress `transcript-partial` overlay
/// (`meetily_core::audio::transcription::partial_worker`).
...
/// `RecordingPhase` (`meetily_core::audio::recording_phase`). Transient
