...
//! `meetily_core::audio::import::start_import_with` and track its progress.
...
//! `meetily_core::audio::import` functions this view calls directly).
...
fn file_picker_section(
    ...
    if let Some(info) = file_info {
        ...
        v_flex()
            ...
            .child(
                Label::new(
                    meetily_core::audio::constants::AUDIO_EXTENSIONS
                        .join(", ")
                        .to_uppercase(),
                )
                .text_xs()
