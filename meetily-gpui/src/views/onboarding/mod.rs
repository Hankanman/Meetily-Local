...
//! `meetily-core` directly instead of through Tauri `invoke()` — every
...
//!
//! `RootView` (`meetily-gpui/src/root.rs`) decides whether to show this at
...
use meetily_core::bootstrap::ModelManagerSlot;
use meetily_core::config::DEFAULT_WHISPER_MODEL;
use meetily_core::database::manager::DatabaseManager;
use meetily_core::database::repositories::setting::SettingsRepository;
use meetily_core::onboarding::{self, ModelStatus as OnboardingModelStatus};
use meetily_core::summary::summary_engine::service as summary_service;
use meetily_core::whisper_engine;
